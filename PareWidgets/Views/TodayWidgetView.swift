...
struct TodayWidgetView: View {
    ...
    private var small: some View {
        ...
        .widgetURL(URL(string: "daysorted://today"))
    }
    ...
    private var progressRingLarge: some View {
        ZStack {
            ...
            Circle()
                .trim(from: 0, to: progress)
                .stroke(Color.pareGreen, style: StrokeStyle(lineWidth: 8, lineCap: .round))
                .rotationEffect(.degrees(-90))
            Text("\(completedCount)")
    ...
    private var accessoryCircular: some View {
        ZStack {
            ...
            Circle()
                .trim(from: 0, to: progress)
                .stroke(Color.pareGreen, style: StrokeStyle(lineWidth: 4, lineCap: .round))
                .rotationEffect(.degrees(-90))
            Text("\(completedCount)")
