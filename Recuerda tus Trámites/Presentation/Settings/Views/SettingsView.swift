...
struct SettingsView: View {
    ...
    private var proSection: some View {
        ...
        return SettingsSection(title: "Recuerda tus Trámites Pro") {
                    ...
                    HStack(spacing: 14) {
                        ZStack {
                            RoundedRectangle(cornerRadius: 10, style: .continuous)
                                .fill(Color.tramiteGreen.opacity(0.15))
                        ...
                        Text("VER")
                            ...
                            .padding(.vertical, 5)
                            .background(Capsule().fill(Color.tramiteGreen))
                    }
                    .padding(.vertical, 4)
        ...
        SettingsSection(title: "settings.notifications") {
            Button {
                ...
                SettingsRow(
                    ...
                    tint: notificationService.isAuthorized ? Color.tramiteGreen : Color.orange,
            ...
            if let url = viewModel.rateAppURL {
                Link(destination: url) {
                    SettingsRow(
                        icon: "star.fill",
                        title: "Valora la App",
                        detail: "¿Te gusta Recuerda tus Trámites? Déjanos una reseña",
                        tint: .yellow,
                        showsChevron: true
                    )
                }
