...
extension Color {
    ...
    static let tramiteBackground     = Color(hex: "#0C0C0E")  // fondo principal
    static let tramiteCard           = Color(hex: "#1A1A1C")  // card background
    static let tramiteCardBorder     = Color(hex: "#2A2A2C")  // card border
    static let tramiteSeparator      = Color(hex: "#222224")  // separadores
    static let tramiteTimelineLine   = Color(hex: "#2A2A2C")  // línea timeline
    static let tramiteSecondaryBg    = Color(hex: "#161618")  // tabbar / sheet

    // MARK: - Text
    static let tramiteTextPrimary    = Color.white
