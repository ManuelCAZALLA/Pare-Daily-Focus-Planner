        ...
        VStack(alignment: .leading, spacing: 8) {
            ...
            HStack(spacing: 12) {
                Button {
                    ...
                    .padding(.vertical, 12)
                    .background(Color.tramiteGreen.opacity(0.10), in: RoundedRectangle(cornerRadius: 14, style: .continuous))
                    .overlay(
                        RoundedRectangle(cornerRadius: 14, style: .continuous)
                            .strokeBorder(Color.tramiteGreen.opacity(0.25), lineWidth: 1)
                    )
                }
                .buttonStyle(.plain)
            }
        ...
        Button(action: action) {
            VStack(alignment: .leading, spacing: 10) {
                Image(systemName: category.systemImage)
                    .font(.title3)
                    .foregroundStyle(isSelected ? Color.tramiteGreen : .secondary)
            ...
            .overlay(
                RoundedRectangle(cornerRadius: 14, style: .continuous)
                    .strokeBorder(isSelected ? Color.tramiteGreen : Color(hex: "#2A2A2C"), lineWidth: isSelected ? 1.5 : 1)
            )
        }
        .buttonStyle(.plain)
    }
        ...
        VStack(alignment: .leading, spacing: 8) {
            HStack {
                ...
                Text(status)
                    ...
                    .foregroundStyle(isRegistered ? Color.tramiteGreen : Color(hex: "#8E8E93"))
                    .padding(.horizontal, 8)
                    .padding(.vertical, 4)
                    .background(isRegistered ? Color.tramiteGreen.opacity(0.12) : Color(hex: "#2A2A2C"), in: Capsule())
            }
