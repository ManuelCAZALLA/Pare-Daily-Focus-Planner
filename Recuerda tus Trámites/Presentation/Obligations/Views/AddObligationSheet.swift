...
struct AddObligationSheet: View {
        ...
        HStack(spacing: 14) {
            ZStack {
                RoundedRectangle(cornerRadius: 12)
                    .fill(Color.tramiteGreen.opacity(0.12))
            ...
            if let data = obligationsVM.scannedDocumentData {
                ...
                Button {
                    ...
                    Label("obligation.scan", systemImage: "doc.viewfinder")
                        ...
                        .padding(.vertical, 14)
                        .background(Color.tramiteGreen.opacity(0.12), in: RoundedRectangle(cornerRadius: 14, style: .continuous))
                }
                .buttonStyle(.plain)
                #endif
            }
        ...
        if let page = PDFDocument(data: data)?.page(at: 0),
           let image = page.thumbnail(of: CGSize(width: 88, height: 112), for: .mediaBox).cgImage {
            ...
            Image(systemName: "doc.fill")
                ...
                .foregroundStyle(Color.tramiteGreen)
                .frame(width: 72, height: 92)
                .background(Color.tramiteGreen.opacity(0.12), in: RoundedRectangle(cornerRadius: 8, style: .continuous))
        }
        #endif
        #if os(watchOS)
        EmptyView()
    ...
    private func dateToggleRow(title: LocalizedStringKey, isOn: Binding<Bool>, date: Binding<Date>) -> some View {
        ...
        .toggleStyle(SwitchToggleStyle(tint: Color.tramiteGreen))
    }
