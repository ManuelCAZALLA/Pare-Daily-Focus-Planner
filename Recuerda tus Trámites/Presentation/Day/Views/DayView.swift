...
struct DayView: View {
    ...
    @State private var taskToEdit: TramiteTask? = nil
    @State private var showRescheduleFor: TramiteTask? = nil
    ...
    private var background: some View {
        ZStack {
            ...
            RadialGradient(
                colors: [Color.tramiteGreen.opacity(0.08), Color.clear],
                center: .top,
                startRadius: 0,
                endRadius: 340
            )
            ...
            if total > 0 {
                ZStack {
                    ...
                    Circle()
                        ...
                        .stroke(
                            LinearGradient(
                                colors: [Color.tramiteGreen.opacity(0.75), Color.tramiteGreen],
                                startPoint: .top,
                                endPoint: .bottom
                            ),
                        ...
                        .shadow(color: allDone ? Color.tramiteGreen.opacity(0.5) : .clear, radius: 6)
    ...
    private var emptyState: some View {
        VStack(spacing: 18) {
            ZStack {
                Circle()
                    .fill(Color.tramiteGreen.opacity(0.08))
            ...
            HStack(spacing: 6) {
                Image(systemName: "arrow.down.right")
                    .font(.system(size: 11, weight: .bold))
                    .foregroundStyle(Color.tramiteGreen.opacity(0.4))
                Text("tasks.addHint")
                    .font(.system(size: 12))
                    .foregroundStyle(Color(hex: "#48484A"))
            }
        ...
        Button {
            ...
            ZStack {
                ...
                Circle()
                    .fill(
                        LinearGradient(
                            colors: [Color.tramiteGreen.opacity(0.95), Color.tramiteGreen],
                            startPoint: .topLeading,
                            endPoint: .bottomTrailing
                        )
                    )
                    .frame(width: 60, height: 60)
                    .shadow(color: Color.tramiteGreen.opacity(0.4), radius: 18, x: 0, y: 8)
                    .overlay(
        ...
        HStack(alignment: .top, spacing: 0) {
            VStack(spacing: 0) {
                Text(task.scheduledTime?.formatted(.dateTime.hour().minute()) ?? "")
                    ...
                    .foregroundStyle(isNow ? Color.tramiteGreen : Color(hex: "#48484A"))
            ...
            ZStack {
                if isNow {
                    Circle()
                        .fill(Color.tramiteGreen.opacity(0.18))
                        .frame(width: 18, height: 18)
                }
                Circle()
                    .fill(isNow ? Color.tramiteGreen : Color(hex: "#222224"))
                    .frame(width: 8, height: 8)
                    .shadow(color: isNow ? Color.tramiteGreen.opacity(0.6) : .clear, radius: 4)
            }
            .frame(width: 20)
            .padding(.top, 16)
