...
struct MorningFlowSheet: View {
    ...
    private func intentionTaskRow(_ task: TramiteTask) -> some View {
...
struct EveningFlowSheet: View {
    ...
    private func carryOverRow(_ task: TramiteTask) -> some View {
    ...
    private func addQuickCaptureTask() {
        ...
        let task = TramiteTask(title: title, scheduledDate: tomorrow, priority: .medium)
        dayVM.addTask(task)
