...
struct OnboardingView: View {
    ...
    var body: some View {
        ZStack {
            Color.tramiteBackground.ignoresSafeArea()
            ...
            VStack {
                ...
                Button(action: {
                    ...
                    Text(viewModel.currentStep == viewModel.totalSteps - 1 ? "Comenzar" : "Siguiente")
                        ...
                        .padding()
                        .background(Color.tramiteGreen)
                        .clipShape(RoundedRectangle(cornerRadius: 16))
                        .shadow(color: Color.tramiteGreen.opacity(0.3), radius: 8, y: 4)
                }
        ...
        VStack(spacing: 24) {
            ...
            VStack(spacing: 12) {
                Text(title)
                    .font(.title)
                    .fontWeight(.bold)
                    .foregroundStyle(Color.tramiteTextPrimary)
                
                Text(description)
                    .font(.body)
                    .multilineTextAlignment(.center)
                    .foregroundStyle(Color.tramiteTextSecondary)
